...
export const initializeInitialTools = () => {
    ...
    registerFileOperationsToolWithId(systemNote, 'file-operations-tool');
...
export const registerFileOperationsToolWithId = (systemNote: SystemNote, toolId: string): void => {
